# no change any in yaml file before join cluster
...
# edit in content/elasticsearch-node2.yml
...
# curl -u elastic --cacert /etc/elasticsearch/certs/http_ca.crt https://els-1:9200/_cluster/health?pretty
